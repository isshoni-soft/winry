...
dependencies {
    api 'institute.isshoni:winry:0.66.0'
}
```
...
* Built to be extended, register new annotations, add more functionality to pre-existing ones, or add new lifecycle events.
    * Import libraries that add their own lifecycle events and gain specialized functionality, e.g. game engine, or, [REST webserver](https://github.com/isshoni-soft/mishima).
